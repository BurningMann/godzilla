...
<template>
  <div class="index-landing">
    ...
    <div class="gender-section-container">
      ...
      <div class="footer">
        <p>
          By proceeding, you're accepting our
          <a href="https://natal-chart.online/palmistry/documents?doc_name=tos-white.html" target="_blank">EULA</a> and
          <a href="https://natal-chart.online/palmistry/documents?doc_name=pp-white.html" target="_blank"
            >Privacy Notice</a
          >.
          <br />
          Need help? Our support team is only a <a href="mailto:support@natal-chart.online">click away</a>. <br /><br />
          Please note, this NatalChart App is purely for amusement and will not predict life expectancy.
        </p>
      </div>
    </div>
  </div>
...
.gender-section-container {
  padding-bottom: 2rem;
  @media screen and (max-height: 700px) and (min-height: 630px) {
    width: 100%;
    position: absolute;
    left: 0;
    bottom: 0;
